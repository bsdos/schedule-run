...
#cs ＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿＿
 ...
 脚本版本: 
 脚本功能: 
 script_watch_interval=检查间隔，-1为自动计算检查间隔，正数为秒数
 execution=y，是否开启
 interval=0,5 0秒5分    0,0,1 0秒0分1小时    0,0,0,1 1天
 
 script_state=自动生成
 script_nexttime=自动生成
 nexttime=自动生成
 state=自动生成
 [aaa]  : 访问http://test.thi-group.com.cn/task.php?ac=aaa
...
Local $hDownload = InetGet($what, @TempDir & "\update.dat", 1, 1)
$a=0
Do
    Sleep(250)
	$a=$a+250
